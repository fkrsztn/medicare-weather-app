...
export function ForecastItem({ forecast }: ForecastItemProps) {
  ...
  return (
    <li className="grid w-full min-w-0 grid-cols-[96px_24px_44px_minmax(0,1fr)] items-center gap-x-2 text-white sm:grid-cols-[130px_36px_84px_1fr] sm:gap-x-5 lg:grid-cols-[150px_40px_88px_1fr] lg:gap-x-6">
      ...
      <span className="block text-right text-[17px] font-light leading-none tracking-[-0.04em] text-white tabular-nums sm:w-[72px] sm:text-[20px] lg:w-[80px] lg:text-[22px]">
